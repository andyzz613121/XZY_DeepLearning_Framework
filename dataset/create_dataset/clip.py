...
if __name__ == '__main__':
    clip = Clip()
    img1_path = 'E:\\dataset\\毕设数据\\new\\2. MS\\Segment\\Train\\6.29\\img_train.tif'
    img2_path = 'E:\\dataset\\毕设数据\\new\\2. MS\\Segment\\Train\\6.29\\lab_train.tif'
    out_folder = 'E:\\dataset\\毕设数据\\new\\2. MS\\Segment\\Train\\6.29\\'
    clip.clip_coupleIMG(img1_path, img2_path, out_folder, step=256)
    # img, para = gdal_read_tif(img2_path)
    # gdal_write_tif('E:\\dataset\\毕设数据\\label\\5. CDL_class_merge_noref.tif', img, para[0], para[1], para[2])

    # img1_path = 'F:\\新建文件夹\\我的数据\\1\\TBM_stack_resample.tif'
    # # img2_path = 'C:\\Users\\25321\\Desktop\\111.tif'
    # out1_folder = 'F:\\新建文件夹\\我的数据\\1\\clip\\'
    # # out2_folder = 'E:\\dataset\\连云港GF2数据\\1_RPC+全色融合\\GF2_PMS1_E119.1_N34.2_20210730_L1A0005787958-pansharp1\\train\\lab\\'
    # clip.clip_singleIMG(img1_path, out1_folder, step=25000, bk_rate=0, datatype=3)
