...
class SegNet_skeleton(nn.Module):
    ...
    def forward(self, x, accuracy_list):
        ...
        conv_5_sideout = F.interpolate(self.CARB5(conv_5), size=(img_h, img_w), mode='bilinear')
        ...
        conv_4_sideout = F.interpolate(self.CARB4(conv_4), size=(img_h, img_w), mode='bilinear')
        ...
        conv_3_sideout = F.interpolate(self.CARB3(conv_3), size=(img_h, img_w), mode='bilinear')
        ...
        conv_2_sideout = F.interpolate(self.CARB2(conv_2), size=(img_h, img_w), mode='bilinear')
        ...
        return conv_1, conv_2_sideout, conv_3_sideout, conv_4_sideout, conv_5_sideout
