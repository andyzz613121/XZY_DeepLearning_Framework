...
class ResU_Net_Skeleton(ResU_Net):
    def __init__(self, arch, input_channels, num_classes, pre_train=True):
        super(ResU_Net_Skeleton, self).__init__(arch, input_channels, num_classes, pre_train)
    ...
    def forward(self, x, accuracy_list):
        ...
        #skeleton
        weight_classifier = self.skeleton_classifier(accuracy_list)

        weight_dc1 = self.skeleton_deconv_1(weight_classifier)
