...
class HS_SI_CM_3D_SAM(nn.Module):
    def __init__(self, input_channels, out_channels):
        print('Using HS_SI_CM_3D_SAM model')
        super(HS_SI_CM_3D_SAM,self).__init__()
        #///////////////////////////////////////////////////////////////////////
        # SP & SA Model
        self.SP_model = SP_2D(out_channels)
        print('Using SP_2D')
        ...
        self.Fuse_fc1 = get_mlp(3, [32, 256, out_channels])
        self.Fuse_fc2 = get_mlp(3, [64, 256, out_channels])
        self.Fuse_fc3 = get_mlp(3, [128, 256, out_channels])
        ...
        self.Fuse_fc5 = get_mlp(3, [128, 256, out_channels])
        #///////////////////////////////////////////////////////////////////////
        # SAM 融合权重
    ...
    def forward_2D(self, x):
        ...
        SAM_std = torch.std(SAM_b)
        if SAM_std > self.std_T:
            w_sp1 = 1 + (self.w_para_SP1*self.w_para_SP1)
            w_sp2 = 1 + (self.w_para_SP2*self.w_para_SP2)
            w_sp3 = 1 + (self.w_para_SP3*self.w_para_SP3)
            w_sa1 = 1
            w_sa2 = 1
            w_sa3 = 1
        elif SAM_std <= self.std_T:
            w_sp1 = 1
            w_sp2 = 1
            w_sp3 = 1
            w_sa1 = 1 + (self.w_para_SA1*self.w_para_SA1)
            w_sa2 = 1 + (self.w_para_SA2*self.w_para_SA2)
            w_sa3 = 1 + (self.w_para_SA3*self.w_para_SA3)
        ...
        # fuse_vec1 = torch.cat([SA1_2D*w_sa1, SP1*w_sp1], 1)
        ...
        # fuse_vec2 = torch.cat([SA2_2D*w_sa2, SP2*w_sp2], 1)
        ...
        # fuse_vec3 = torch.cat([SA3_2D*w_sa3, SP3*w_sp3], 1)
