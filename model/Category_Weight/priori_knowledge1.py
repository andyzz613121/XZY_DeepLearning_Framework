...
class pri_knowlegde(nn.Module):
    def __init__(self):
        ...
        self.dem_weight = torch.ones([5]).float()
        self.ndvi_weight = torch.ones([5]).float()
        self.dis_weight = torch.ones([5]).float()
    ...
    def cal_pri_knowledge_weight(self, predict, label):
        ...
        for pre_class in range(5):
            mis_class = (sum(self.confuse_matrix[pre_class])-self.confuse_matrix[pre_class][pre_class])
            self.weight_matrix[pre_class] = self.confuse_matrix[pre_class]/mis_class
            if mis_class/self.confuse_matrix[pre_class][pre_class] < 0.1:
                self.weight_matrix[pre_class] *= 0
        print(self.weight_matrix)
        self.dem_weight[0] = 1 + self.weight_matrix[0][1] + self.weight_matrix[0][3]
        self.dis_weight[0] = 1 + self.weight_matrix[0][4]
        self.ndvi_weight[0] = 1 + self.weight_matrix[0][2] + self.weight_matrix[0][3]

        self.dem_weight[1] = 1 + self.weight_matrix[1][0] + self.weight_matrix[1][2] + self.weight_matrix[1][4]
        self.dis_weight[1] = 1 + self.weight_matrix[1][4]
        # self.ndvi_weight[1] = 1 + self.weight_matrix[1][2] + self.weight_matrix[1][3]
        self.ndvi_weight[1] = 1 + self.weight_matrix[1][3]

        self.dem_weight[2] = 1 + self.weight_matrix[2][1] + self.weight_matrix[2][3]
        # self.ndvi_weight[2] = 1 + self.weight_matrix[2][0] + self.weight_matrix[2][1] + self.weight_matrix[2][4]
        self.ndvi_weight[2] = 1 + self.weight_matrix[2][0] + self.weight_matrix[2][4]

        self.dem_weight[3] = 1 + self.weight_matrix[3][0] + self.weight_matrix[3][2] + self.weight_matrix[3][4]
        self.ndvi_weight[3] = 1 + self.weight_matrix[3][0] + self.weight_matrix[3][1] + self.weight_matrix[3][4]

        self.dem_weight[4] = 1 + self.weight_matrix[4][1] + self.weight_matrix[4][3]
        self.dis_weight[4] = 1 + self.weight_matrix[4][0] + self.weight_matrix[4][1]
        self.ndvi_weight[4] = 1 + self.weight_matrix[4][2] + self.weight_matrix[4][3]

        return self.dem_weight, self.dis_weight, self.ndvi_weight
