...
class SegNet_img(nn.Module):
    ...
    def forward_first(self, x, label):
        ...
        out_PRD = torch.argmax(out_PRD, 1)
        dem_weight_D, dis_weight_D, ndvi_weight_D = self.prio.cal_pri_knowledge_weight(out_PRD, label)
        
        self.dem_weight_list5.append(dem_weight_D)
        self.dis_weight_list5.append(dis_weight_D)
        self.ndvi_weight_list5.append(ndvi_weight_D)
