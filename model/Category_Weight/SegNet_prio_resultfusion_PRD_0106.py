...
class SegNet_img(nn.Module):
    def __init__(self, input_channels, output_channels, pre_train=True):
        ...
        self.CARB_block1 = CARB_Block(12, 1)
        self.CARB_block2 = CARB_Block(12, 1)
        self.CARB_block3 = CARB_Block(12, 1)
        self.CARB_block4 = CARB_Block(12, 1)
        self.CARB_block5 = CARB_Block(12, 1)
    ...
    def forward_second(self, x, prio_features_list1, prio_features_list2, prio_features_list3, prio_features_list4, prio_features_list5):
        ...
        out_5_1 = self.CARB_block1(torch.cat([out_PRD, fuse_5[0]], 1))
        out_5_2 = self.CARB_block2(torch.cat([out_PRD, fuse_5[1]], 1))
        out_5_3 = self.CARB_block3(torch.cat([out_PRD, fuse_5[2]], 1))
        out_5_4 = self.CARB_block4(torch.cat([out_PRD, fuse_5[3]], 1))
        out_5_5 = self.CARB_block5(torch.cat([out_PRD, fuse_5[4]], 1))
...
class SegNet_prio(nn.Module):
    ...
    def forward(self, x):
        ...
        conv_1 = self.unpool(conv_2,index_1,output_size=conv_1_copy.shape)
        conv_1 = self.deconv_1_half(conv_1)
        conv_1 = self.deconv_1_classifier(conv_1)
